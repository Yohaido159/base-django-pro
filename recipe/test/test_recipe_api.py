...
class PrivateRecipeApiTest(TestCase):
    def setUp(self):
        ...
        self.user = get_user_model().objects.create_user(
            "yohaitetst@gmail.com", password="12345")
    ...
    def test_create_api_recipe(self):
        payload = {"title": "Chocolate cheesecake",
                   "time_minutes": 30, "price": 10.00}
    ...
    def test_create_recipe_witj_ingredient(self):
...
class RecipeImageUploadTest(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(
            email="useryohai@example.com", password="12345"
        )
        self.client.force_authenticate(self.user)
    ...
    def test_upload_image_bad_request(self):
        url = image_upload_url(self.recipe.id)
        res = self.client.post(url, {"image": "no"}, format="multipart")
    ...
    def test_filter_by_tags(self):
        ...
        tag1 = sample_tag(user=self.user, name="Vegen")
        tag2 = sample_tag(user=self.user, name="Vegentarian")
